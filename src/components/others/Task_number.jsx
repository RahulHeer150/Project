...
const Task_number = () => {
  return (
    <div className='flex mt-10 screen justify-between gap-5 '>
        ...
        <div className='w-[45%]  rounded-xl py-6 px-7 bg-green-400'>
            <h2 className='text-3xl font-semibold'>1</h2>
            <h3 className='text-xl font-medium'>New Task</h3>
        </div>
        <div className='w-[45%]  rounded-xl py-6 px-7 bg-blue-400'>
            <h2 className='text-3xl font-semibold'>2</h2>
            <h3 className='text-xl font-medium'>New Task</h3>
        </div>
        <div className='w-[45%]  rounded-xl py-6 px-7 bg-orange-400'>
